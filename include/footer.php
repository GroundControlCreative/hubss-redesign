		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-7 col-md-12">
					<div class="row mb-sm-30">
						<div class="col-sm-3 footer-links  mb-mob-30">
							<h3>COMPANY</h3>
							<a href="<?php echo $base_url.'about-hubss.php'?>">About Us</a>
							<a href="<?php echo $base_url.'#contact-us'?>">Contact</a>
							<a href="<?php echo $base_url.'installation-services.php'?>">Installation</a>
							<a href="<?php echo $base_url.'specification-support-documents.php'?>">Support Docs</a>
						</div>
						<div class="col-sm-3 col-6 footer-links px-sm-0 mb-mob-30">
							<h3>PRODUCTS</h3>
							<a href="<?php echo $base_url.'streetprint-genuine-stamped-asphalt.php'?>">StreetPrint</a>
							<a href="<?php echo $base_url.'streetbond-150.php'?>">StreetBond 150   </a>
							<a href="<?php echo $base_url.'streetbond-sr.php'?>">StreetBond SR   </a>
							<a href="<?php echo $base_url.'decomark.php'?>"> DecoMark      </a>
							<a href="<?php echo $base_url.'premark.php'?>" class="d-none dp-sm" > 	PreMark     </a>
							<a href="<?php echo $base_url.'airmark.php'?>" class="d-none dp-sm" >   AirMark   </a>
						</div>
						<div class="col-sm-3 col-6  mt footer-links px-sm-0">
							<a href="<?php echo $base_url.'trafficpatterns.php'?>">TrafficPatterns   </a>
							<a href="<?php echo $base_url.'trafficpatterns-xd.php'?>">TrafficPatterns XD  </a>
							<a href="<?php echo $base_url.'duratherm.php'?>"> DuraTherm      </a>
							<a href="<?php echo $base_url.'durashield.php'?>" 	  class="d-none dp-sm"  > 	DuraShield     </a>
						</div>
						<div class="col-sm-3 col-6 mt footer-links px-sm-0  dp-sm-none">
			...
			<div class="row">
				<div class="col-lg-3 col-md-7 footer-logo">
					<a href="<?php echo $base_url ?>"><img src="assets/img/logo_footer.png" class="img-fluid" alt="image"></a>
				</div>
					...
					<ul class="footer-icons text-right">
						<li>
							<a href="https://www.houzz.com/pro/hubss/hub-surface-systems" target="_blank">
								<img style="margin-bottom: 10px" src="assets/img/houzz_logo.png" alt="Innovative decorative hardscape, pattern paving and stamped asphalt solutions for applications including decorative crosswalks, traffic calming device treatments, complete streetscape beautification, community and commercial branding, horizontal wayfinding device treatments, water parks, park pathways and plazas, commercial parking lots, public art and decorative driveways">
							</a>
						</li>
